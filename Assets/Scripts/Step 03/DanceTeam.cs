...
public class DanceTeam : MonoBehaviour
{
    ...
    private List<CharacterName> allCharacterNames = new List<CharacterName>(); // a list to hold all our character name references.

    /// <summary>
    /// Takes in a dancer prefab and loops over all the spawn points in the game and spawns a dancer for us.
    /// Step 03: Called from the dance team init class on the first frame.
    /// </summary>
    ...
    /// <summary>
    /// takes in a dancer gameobject and we want to grab all the component references from it and store them.
    /// </summary>
